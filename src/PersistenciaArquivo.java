    ...
    public static void salvarUsuarios(Usuario[] usuarios, int qtd) {
        try {
            ...
            for (int i = 0; i < qtd; i++) {
                ...
                escritor.println(u.getUser() + "|" + u.getCpf() + "|" + u.getSenha() + "|" +
                        u.getIdade() + "|" + u.getSexo() + "|" + u.getEmail() + "|" +
                        u.getNomecartao() + "|" + u.getNumerocartao() + "|" + u.getCodigocartao());
            }
    ...
    public static Usuario[] carregarUsuarios(int[] qtdLida) {
        ...
        try {
            ...
            while ((linha = leitor.readLine()) != null && qtd < MAX) {
                ...
                if (c.length == 9) {
                    usuarios[qtd] = new Usuario(c[0], c[1], c[2], Integer.parseInt(c[3]),
                            c[4].charAt(0), c[5], c[6], c[7], c[8]);
                    qtd++;
                }
            }
            leitor.close();
